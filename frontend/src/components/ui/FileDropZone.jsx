...
const FileDropzone = ({
  ...
  return (
    <div className="space-y-1">
      {value ? (
        <div className="flex items-center gap-3 p-3 border border-green-400 bg-green-50 rounded-lg">
          ...
          <button
            ...
            className="text-green-700 hover:text-red-600 text-lg leading-none"
          >
            ✕
          </button>
        </div>
        ...
        >
          ...
          <p className="text-sm text-gray-600">{label} <span className="text-blue-700 font-medium">Pilih File</span></p>
