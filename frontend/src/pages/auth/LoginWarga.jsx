      ...
      <div className="w-full max-w-sm bg-white border border-gray-200 rounded-xl shadow-md p-7">
        ...
        <div className="mt-5 text-center space-y-2">
          <p className="text-xs text-gray-500">
            Belum punya akun?{' '}
            <Link to="/register-warga" className="text-blue-600 hover:underline font-medium">Daftar di sini</Link>
          </p>
          <p className="text-xs text-gray-400">
            Pengurus RT/RW?{' '}
            <Link to="/login-rtrw" className="text-blue-600 hover:underline">Login RT/RW</Link>
          </p>
        </div>
      </div>
    </div>
