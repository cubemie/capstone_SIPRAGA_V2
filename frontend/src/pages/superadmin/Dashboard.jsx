  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <StatCard icon={<FileText />} label="Template Aktif" value={loading ? '...' : templates.length} colorClass="text-primary-light" />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white border border-neutral-100 rounded-lg p-6 shadow-sm">
          ...
          <Link to="/superadmin/template" className="inline-block px-4 py-2 bg-primary text-white text-sm font-semibold rounded hover:bg-primary-dark">
            Kelola Template
          </Link>
        </div>
        ...
        <div className="bg-white border border-neutral-100 rounded-lg p-6 shadow-sm">
          ...
          <button onClick={() => alert('Fitur segera hadir')} className="inline-block px-4 py-2 bg-neutral-50 text-gray-700 text-sm font-semibold rounded border border-gray-300 hover:bg-gray-200">
