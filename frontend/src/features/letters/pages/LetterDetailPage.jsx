  ...
  return (
    <div className="bg-[var(--color-surface-card)] border border-surface-border rounded-xl p-4 space-y-4">
      ...
      <textarea
        ...
        rows={2}
        placeholder="Catatan (wajib diisi jika menolak surat)..."
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          disabled={approveMutation.isPending || rejectMutation.isPending}
          className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-[var(--color-danger)] text-white text-sm font-semibold rounded-xl hover:bg-[var(--color-danger-dark)] transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
