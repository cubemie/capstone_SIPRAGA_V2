...
-- 1. Konfigurasi instansi (nama desa, logo, dll)
...
-- Seed data konfigurasi default
INSERT INTO instance_config (config_key, config_value, label) VALUES
  ('nama_desa',        'Srondol Wetan',      'Nama Desa/Kelurahan'),
  ('kecamatan',        'Banyumanik',         'Kecamatan'),
  ('kabupaten_kota',   'Kota Semarang',      'Kabupaten/Kota'),
  ('provinsi',         'Jawa Tengah',        'Provinsi'),
  ('kode_pos',         '50263',              'Kode Pos'),
  ('logo_url',         NULL,                 'URL Logo Instansi'),
  ('kepala_desa',      '',                   'Nama Kepala Desa/Lurah'),
  ('nip_kepala_desa',  '',                   'NIP Kepala Desa/Lurah'),
  ('kop_surat_line1',  'PEMERINTAH KOTA SEMARANG', 'Kop Surat Baris 1'),
